...
export const PANTONE = [
  { key:'peach',    color:'#FFBE98', bg:'rgba(255,190,152,.10)', br:'rgba(255,190,152,.35)', text:'#a05a20', label:'Peach Fuzz' },
  { key:'mocha',    color:'#A67B5B', bg:'rgba(166,123,91,.10)',  br:'rgba(166,123,91,.35)',  text:'#6a3a20', label:'Mocha' },
  { key:'ciel',     color:'#7BBFCB', bg:'rgba(123,191,203,.10)', br:'rgba(123,191,203,.35)', text:'#2a6a7a', label:'Ciel' },
  { key:'apricot',  color:'#E8A87C', bg:'rgba(232,168,124,.10)', br:'rgba(232,168,124,.35)', text:'#8a4a10', label:'Apricot' },
  { key:'sage',     color:'#9CAF88', bg:'rgba(156,175,136,.10)', br:'rgba(156,175,136,.35)', text:'#3a6030', label:'Sage' },
  { key:'artgold',  color:'#C9A96E', bg:'rgba(201,169,110,.10)', br:'rgba(201,169,110,.35)', text:'#6a4a10', label:'Artisan Gold' },
  { key:'granite',  color:'#B5C4B1', bg:'rgba(181,196,177,.10)', br:'rgba(181,196,177,.35)', text:'#3a5535', label:'Granite' },
  { key:'rose',     color:'#D4A5A5', bg:'rgba(212,165,165,.10)', br:'rgba(212,165,165,.35)', text:'#703535', label:'Mellow Rose' },
  { key:'cerulean', color:'#A8C5DA', bg:'rgba(168,197,218,.10)', br:'rgba(168,197,218,.35)', text:'#1a5070', label:'Cerulean' },
  { key:'slate',    color:'#6B7C93', bg:'rgba(107,124,147,.10)', br:'rgba(107,124,147,.35)', text:'#2a3a55', label:'Blue Slate' },
  { key:'sand',     color:'#E8D5B7', bg:'rgba(232,213,183,.10)', br:'rgba(232,213,183,.35)', text:'#6a4a20', label:'Sand' },
  { key:'caramel',  color:'#C4956A', bg:'rgba(196,149,106,.10)', br:'rgba(196,149,106,.35)', text:'#6a3010', label:'Caramel' },
  { key:'laurel',   color:'#8FA68E', bg:'rgba(143,166,142,.10)', br:'rgba(143,166,142,.35)', text:'#2a5028', label:'Laurel' },
  { key:'flamingo', color:'#D4869B', bg:'rgba(212,134,155,.10)', br:'rgba(212,134,155,.35)', text:'#7a2045', label:'Flamingo' },
  { key:'steel',    color:'#7B9EA6', bg:'rgba(123,158,166,.10)', br:'rgba(123,158,166,.35)', text:'#1a4a55', label:'Steel Blue' },
]
